...
NOTE: 您也可以使用 Aggregate 重定位將 AFF A800 升級至 AFF A70 或 AFF A90 。link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-app-9151/index.html["深入瞭解"]。
