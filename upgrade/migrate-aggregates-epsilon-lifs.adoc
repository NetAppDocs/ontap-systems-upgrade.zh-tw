---
permalink: upgrade/migrate-aggregates-epsilon-lifs.html 
sidebar: sidebar 
keywords: fas2820, aff a150, aff a220, ndu, nondisruptive, upgrade, node1, node4, migrate, aggregates, lifs 
...
[role="lead"]
將 AFF A150 、 AFF A220 或 FAS2820 node1 上的資料集合體、 epsilon 和邏輯介面（ LIF ）移轉至 node4 。
...
.接下來呢？
link:convert-node1-to-drive-shelf.html["將 node1 轉換為磁碟機櫃、並連線至 node3"]
