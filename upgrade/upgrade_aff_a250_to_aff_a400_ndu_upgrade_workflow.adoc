...
---
= 了解如何將 AFF A250 轉換為磁碟機櫃，以及如何將儲存設備移至 AFF A400
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
將 AFF A250 系統無中斷升級至 AFF A400 系統。首先，將 AFF A250 節點轉換為 NS224 磁碟機櫃。然後，將它們連接至 AFF A400 替換節點。這會將 AFF A250 板載儲存設備移至 AFF A400 替換系統。
...
[role="quick-margin-para"]
將 AFF A250 node2 轉換為 NS224 磁碟機櫃，然後連接到 AFF A400 node4，再將磁碟機從 node2 重新指派到 node4。
...
[role="quick-margin-para"]
將 AFF A250 node1 轉換為 NS224 磁碟機櫃，然後連接到 AFF A400 node3，再將磁碟機從 node1 重新指派到 node3。
