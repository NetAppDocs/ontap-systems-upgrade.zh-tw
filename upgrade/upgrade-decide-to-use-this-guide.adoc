...
.相關資訊
* link:upgrade_aff_a250_to_aff_a400_ndu_upgrade_workflow.html["了解如何將 AFF A250 轉換為磁碟機櫃，以及如何將儲存設備移至 AFF A400"] （不中斷營運的程序）
* link:convert-to-drive-shelf.html["透過轉換為磁碟機櫃，從 AFF A150、AFF A220 或 FAS2820 升級"] （不中斷營運的程序）
