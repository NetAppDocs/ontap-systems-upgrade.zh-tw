...
* 此程序適用於MetroCluster 執行ONTAP 版本號為「版本資訊」9.5或更早版本的所有四節點和八節點組態。如需MetroCluster 執行ONTAP 效能不可靠的更新版本、請前往 link:other_references.html["參考資料"] 使用「系統控制器更換」命令連結至_、將執行ONTAP VMware 9.5的控制器硬體升級至ONTAP VMware 9.7。
