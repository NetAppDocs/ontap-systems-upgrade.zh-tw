...
[role="lead"]
本內容說明如何升級AFF 搭配全新AFF 的更新版的更新版、以搭配使用的更新版的功能、同時保留所有現有的資料和磁碟。這是一個複雜的程序、只能由經驗豐富的系統管理員使用。

請在下列情況下使用此程序：

* 您已向NetApp銷售代表確認、您已收到AFF 一個不完整的控制器模組和NVRAM模組、以及升級所需的零件。
...
* 您正在FlexArray 使用的是AFF 功能不實的虛擬化軟體。
