...
summary: '升級至 ONTAP 9.15.1 或更新版本中引入的控制器後，請使用 `system controller replace`命令通知 NetApp 舊系統已不再運作。' 
---
= 取消委任舊系統
:hardbreaks:
:allow-uri-read: 
...
.接下來呢？
舊系統退役後，link:resume_snapmirror_operations.html["恢復 SnapMirror 作業"]。
