...
summary: '如果需要，升級到 ONTAP 9.15.1 或更新版本中引入的控制器時，可以使用 `system controller replace`命令為 NVE 或 NAE 配置新的控制器模組。' 
---
...
.接下來呢？
在新的控制器模組上設定 NetApp Volume 或 Aggregate Encryption 後，link:decommission_old_system.html["停用舊系統"]。
