...
| FAS2720 | 9.13.1 或更新版本 | FAS2820 | 9.13.1 或更新版本 


| FAS2760 | 9.11.1P7 或更早版本 | FAS2820 | 9.13.1 或更新版本 
...
.接下來呢？
決定是否使用此 ARL 程序後，請了解 link:required_tools_and_documentation.html["所需工具和說明文件"]。
