...
但是，如果您有 V 系列系統或擁有 FlexArray 虛擬化軟體，並且連接至儲存陣列，而 node4 則沒有內建 FC 連接埠，內建 UTA/ UTA2 連接埠或 UTA/UTA2 卡，則必須返回至 _ 安裝並開機 node4_ link:install_boot_node4.html#step22["步驟22"]，然後繼續執行中的程序。
...
** 如果 node4 沒有 UTA/UTA2 卡或 UTA/UTA2 板載端口，請跳過 _Check 並在 node4_ 上配置 UTA/UTA2 端口，返回至 _Install and boot node4_ ，然後繼續執行中的步驟link:install_boot_node4.html#auto_install4_step23["步驟23"]。
