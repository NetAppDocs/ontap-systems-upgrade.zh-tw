...
summary: 了解如何使用聚合重新定位來升級 AFF、ASA 或 FAS 控制器硬體。 
---
= 從這裡開始：選擇適用於 AFF、ASA 或 FAS 控制器硬體的 ARL 升級程序
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
您可以使用集合體重新定位 (ARL) 來升級 AFF、ASA 或 FAS 控制器硬體，而不會造成服務中斷。如需升級控制器硬體的其他方法，請參閱 link:../upgrade/upgrade-decide-to-use-this-guide.html["透過移動磁碟區或儲存設備進行升級"]。
...
[[upgrade-to-systems-introduced-in-ontap-9-15-1-or-later]]
== 升級至 ONTAP 9.15.1 或更新版本中引入的系統

如果您的升級方案列在以下支援的系統矩陣中，請前往link:../upgrade-arl-auto-app-9151/index.html["使用「system controller replace」指令升級至 ONTAP 9.15.1 或更新版本中引入的控制器硬體"]以開始升級程序。
...
| AFF A70 | AFF A90 | 9.18.1 及更高版本 


| AFF A30 | AFF A50 | 9.18.1 及更高版本 


| AFF A20 | AFF A30 、 AFF A50 | 9.18.1 及更高版本 


| AFF C30 | AFF C60 | 9.18.1 及更高版本 


| FAS70 | FAS90 | 9.18.1 及更高版本 
