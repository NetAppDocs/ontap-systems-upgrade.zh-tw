...
---
= 更換節點 1 AFF A250 或 AFF C250 控制器模組
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
將節點 1 的 AFF A250 或 AFF C250 控制器模組更換為 AFF A30 、 AFF A50 、 AFF C30 或 AFF C60 控制器模組。
...
若要拆卸 node1 控制器模組，請先移除纜線管理裝置並解鎖鎖定閂鎖。然後，將控制器模組從機箱中取出。
...
.接下來呢？
安裝 AFF A30、AFF A50、AFF C30 或 AFF C60 控制器模組後，link:netboot-node1.html["netboot node1"]。
