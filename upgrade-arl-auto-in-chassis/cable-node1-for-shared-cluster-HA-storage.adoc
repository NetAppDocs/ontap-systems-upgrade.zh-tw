...
summary: 將先前連接到 AFF A800 節點 1 的叢集、HA、儲存和資料連線連接到新安裝的 AFF A90 或 AFF A70 節點 1。 
---
...
.接下來呢？
在為共享叢集高可用性和儲存連接節點 1 之後，link:boot-node1-with-a900-controller-and-nvs.html["使用替換系統模組啟動 node1"]
