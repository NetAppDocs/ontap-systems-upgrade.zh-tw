...
summary: 在同一機箱內對控制器型號進行 ARL 升級時，請在 node2 中安裝替換系統模組。 
---
= 在節點 2 中安裝 ASA A150、AFF A150 或 FAS2820 控制器模組
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
將您收到的用於升級的 ASA A150、AFF A150 或 FAS2820 控制器模組安裝到節點 2 中。從系統後方看控制器時，節點 2 是位於機殼右側的控制器 B。
