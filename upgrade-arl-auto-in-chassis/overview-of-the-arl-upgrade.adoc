...
| link:verify-upgrade-hardware.html["階段1：準備升級"]  a| 
...
| link:relocate-non-root-aggr-and-nas-data-lifs-node1-node2.html["第 2 階段：重新部署資源並淘汰 node1"]  a| 
...
| link:relocate-non-root-aggr-nas-lifs-from-node2-to-node1.html["第 4 階段：重新部署資源並淘汰 node2"]  a| 
...
| link:install-aff-a30-a50-c30-c50-node2.html["第 5 階段：安裝 node2 更換系統模組"]  a| 
...
| link:cable-node2-for-shared-cluster-HA-storage.html["階段 6 ：使用替換系統模組來啟動 node2"]  a| 
...
|===
.接下來呢？
在了解 ARL 升級順序之後，link:verify-upgrade-hardware.html["驗證升級硬體"]。
