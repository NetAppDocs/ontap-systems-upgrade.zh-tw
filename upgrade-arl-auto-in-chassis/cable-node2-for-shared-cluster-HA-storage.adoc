...
summary: 將先前連接到 AFF A800 node2 的叢集、HA、儲存和資料連線連接到新安裝的 AFF A90 或 AFF A70 node2。 
---
...
.接下來呢？
在為共享叢集 HA 和儲存設備連接 node2 之後，link:boot-node2-with-a900-controller-and-nvs.html["使用替換系統模組啟動 node2"]。
